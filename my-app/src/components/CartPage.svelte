...
>
	...
	<div class="page-contents">
			...
			<div class="buttons" style="margin-right:{cartVisibleMargin}">
				...
				<div class="tooltip-container">
					<div on:click={toggleCart}>
						...
						>
							<path
								d="M15 15.5H102L116.263 77M164.5 285L116.263 77M116.263 77H492.5L437.5 285H165C147 285 133 298 133 317C133 336 151 345 167 345C183 345 349.333 345 437.5 345"
								stroke-width="30"
		...
		<div class="main-content">
			<DragAndDrop
				bind:glowCart
				itemsStart={itemsStart[gameNumber]}
				bind:gameNumber
				bind:items1
			/>
		</div>
